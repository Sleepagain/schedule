...
<body>
    ...
    <div class="alert alert-info">当前位置<b class="tip"></b>专业管理<b class="tip"></b>新增</div>
<form action="<%=basePath %>major/majoradd.html" method="post">
            ...
            <tr>
                ...
                <td>
                	<c:forEach var="classes" items="${classeslist}" varStatus="status">
                    	<label><input name="kc" type="checkbox" value="${classes.type}" />${classes.type} </label> 
                    </c:forEach>
                </td>
            </tr>
            <tr>
