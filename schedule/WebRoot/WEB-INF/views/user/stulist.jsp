...
<head>
    ...
    <script type="text/javascript">
		...
		function goPager(pager){
			...
			window.location.href="<%=basePath%>user/list.html?isadmin=2&pagerNum="+pager;
 		}
    </script>
</head>
<body>
    ...
    <div class="alert alert-info">当前位置<b class="tip"></b>学生管理<b class="tip"></b>列表
    	<font style="float: right;margin-top: -5px;"><input class="btn top-next" id="find" onclick="javascript:window.location.href='<%=basePath%>user/toadd.html?isadmin=2';" type="button" value="新增" /></font>
    </div>
        ...
        <c:forEach var="user" items="${list}" varStatus="status">
            <tr>
                ...
                <td>
                	...
                	<a href="javascript:window.location.href='<%=basePath%>user/del.html?id=${user.id}&isadmin=2';" class="btn btn-mini btn-danger del">删除</a>
                </td>
            </tr>
        </c:forEach>
