...
<body>
    ...
    <div class="alert alert-info">当前位置<b class="tip"></b>教室管理<b class="tip"></b>修改</div>
<form action="<%=basePath %>room/update.html" method="post">
    <table class="table table-striped table-bordered table-condensed list">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="text" name="address" id="address" value="${room.address}" />
                </td>
            </tr>
        </tbody>
        <tfoot>
