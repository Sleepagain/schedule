...
<body>
    ...
    <div class="alert alert-info">当前位置<b class="tip"></b>课程管理<b class="tip"></b>添加</div>
<form action="<%=basePath %>dict/add.html" method="post">
    <table class="table table-striped table-bordered table-condensed list">
        ...
        <tbody>
            ...
            <tr>
                ...
                <td>
                    <input type="number" name="beginweek" id="beginweek" value="" />
                </td>
            </tr>
            <tr>
                <td >开课结束周<font color="FF0000">*</font></td>
                <td>
                    <input type="number" name="endweek" id="endweek" value="" />
                </td>
            </tr>
            <tr>
                <td >课程时间<font color="FF0000">*</font></td>
                <td>
                    <input type="number" name="period" id="period" value="" />
                </td>
            </tr>
        </tbody>
        <tfoot>
