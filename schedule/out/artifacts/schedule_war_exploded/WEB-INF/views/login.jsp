...
<link rel="stylesheet" type="text/css" href="<%=basePath %>resources/yzm/css/style.css" />
<link rel="stylesheet" type="text/css" href="<%=basePath %>resources/yzm/css/skin_/login.css" />
<script type="text/javascript" src="<%=basePath %>resources/yzm/js/jquery.js"></script>
<script type="text/javascript" src="<%=basePath %>resources/yzm/js/jquery.select.js"></script>
